...
const ModuleURLUtility_js_1 = __importDefault(require("./ModuleURLUtility.cjs"));
 ...
 */
class ECMAScriptModuleCompiler {
    window;
    /**
     * Constructor.
     *
    ...
    compile(moduleURL, code) {
        const browserSettings = new WindowBrowserContext_js_1.default(this.window).getSettings();
        ...
        while ((match = regExp.exec(code))) {
            ...
            if (count.comment === 0 &&
                ...
                if (match[1] && PRECEDING_STATEMENT_TOKEN_REGEXP.test(precedingToken)) {
                    ...
                    imports.push({
                        url: ModuleURLUtility_js_1.default.getURL(this.window, moduleURL, match[1]).href,
                        type: 'esm'
                    });
                    ...
                    if (importStartIndex !== -1) {
                        const url = ModuleURLUtility_js_1.default.getURL(this.window, moduleURL, match[4]).href;
                    ...
                    const url = ModuleURLUtility_js_1.default.getURL(this.window, moduleURL, match[8]).href;
...
exports.default = ECMAScriptModuleCompiler;
//# sourceMappingURL=ECMAScriptModuleCompiler.cjs.map
