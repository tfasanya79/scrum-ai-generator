 ...
 */
class Event {
    static NONE = EventPhaseEnum_js_1.default.none;
    static CAPTURING_PHASE = EventPhaseEnum_js_1.default.capturing;
    static AT_TARGET = EventPhaseEnum_js_1.default.atTarget;
    static BUBBLING_PHASE = EventPhaseEnum_js_1.default.bubbling;
    NONE = Event.NONE;
