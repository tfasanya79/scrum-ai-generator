...
const SVGPreserveAspectRatio_js_1 = __importDefault(require("./SVGPreserveAspectRatio.cjs"));
/**
...
class SVGAnimatedPreserveAspectRatio {
    ...
    get animVal() {
        if (!this[PropertySymbol.animVal]) {
            this[PropertySymbol.animVal] = new SVGPreserveAspectRatio_js_1.default(PropertySymbol.illegalConstructor, this[PropertySymbol.window], {
                readOnly: true,
    ...
    get baseVal() {
        if (!this[PropertySymbol.baseVal]) {
            this[PropertySymbol.baseVal] = new SVGPreserveAspectRatio_js_1.default(PropertySymbol.illegalConstructor, this[PropertySymbol.window], {
                getAttribute: this[PropertySymbol.getAttribute],
...
exports.default = SVGAnimatedPreserveAspectRatio;
//# sourceMappingURL=SVGAnimatedPreserveAspectRatio.cjs.map
