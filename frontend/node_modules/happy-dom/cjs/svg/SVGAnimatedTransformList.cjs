...
const SVGTransformList_js_1 = __importDefault(require("./SVGTransformList.cjs"));
...
class SVGAnimatedTransformList {
    ...
    get animVal() {
        if (!this[PropertySymbol.animVal]) {
            this[PropertySymbol.animVal] = new SVGTransformList_js_1.default(PropertySymbol.illegalConstructor, this[PropertySymbol.window], {
                readOnly: true,
    ...
    get baseVal() {
        if (!this[PropertySymbol.baseVal]) {
            this[PropertySymbol.baseVal] = new SVGTransformList_js_1.default(PropertySymbol.illegalConstructor, this[PropertySymbol.window], {
                getAttribute: this[PropertySymbol.getAttribute],
...
exports.default = SVGAnimatedTransformList;
//# sourceMappingURL=SVGAnimatedTransformList.cjs.map
