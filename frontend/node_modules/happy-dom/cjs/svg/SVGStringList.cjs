...
class SVGStringList {
    ...
    constructor(illegalConstructorSymbol, window, options) {
        ...
        const methodBinder = new ClassMethodBinder_js_1.default(this, [SVGStringList]);
    ...
    removeItem(index) {
        ...
        if (index >= items.length) {
            throw new this[PropertySymbol.window].DOMException(`Failed to execute 'removeItem' on 'SVGStringList':  The index provided (${index}) is greater than the maximum bound.`, DOMExceptionNameEnum_js_1.default.indexSizeError);
        }
        if (index < 0) {
            throw new this[PropertySymbol.window].DOMException(`Failed to execute 'removeItem' on 'SVGStringList':  The index provided (${index}) is negative.`, DOMExceptionNameEnum_js_1.default.indexSizeError);
        }
...
exports.default = SVGStringList;
//# sourceMappingURL=SVGStringList.cjs.map
