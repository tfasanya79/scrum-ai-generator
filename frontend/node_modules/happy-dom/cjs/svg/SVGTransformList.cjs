...
class SVGTransformList {
    ...
    constructor(illegalConstructorSymbol, window, options) {
        ...
        const methodBinder = new ClassMethodBinder_js_1.default(this, [SVGTransformList]);
    ...
    initialize(newItem) {
        ...
        if (!(newItem instanceof SVGTransform_js_1.default)) {
    ...
    removeItem(index) {
        ...
        if (index >= items.length) {
            throw new this[PropertySymbol.window].DOMException(`Failed to execute 'removeItem' on 'SVGTransformList':  The index provided (${index}) is greater than the maximum bound.`, DOMExceptionNameEnum_js_1.default.indexSizeError);
        }
        if (index < 0) {
            throw new this[PropertySymbol.window].DOMException(`Failed to execute 'removeItem' on 'SVGTransformList':  The index provided (${index}) is negative.`, DOMExceptionNameEnum_js_1.default.indexSizeError);
        }
    ...
    [PropertySymbol.getItemList]() {
        ...
        if (trimmed) {
            ...
            while ((match = regexp.exec(trimmed))) {
                const item = new SVGTransform_js_1.default(PropertySymbol.illegalConstructor, this[PropertySymbol.window], {
...
exports.default = SVGTransformList;
//# sourceMappingURL=SVGTransformList.cjs.map
