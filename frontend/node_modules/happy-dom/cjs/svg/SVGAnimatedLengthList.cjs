...
const SVGLengthList_js_1 = __importDefault(require("./SVGLengthList.cjs"));
/**
 * SVG Animated Length.
 *
...
class SVGAnimatedLengthList {
    ...
    get animVal() {
        if (!this[PropertySymbol.animVal]) {
            this[PropertySymbol.animVal] = new SVGLengthList_js_1.default(PropertySymbol.illegalConstructor, this[PropertySymbol.window], {
                readOnly: true,
    ...
    get baseVal() {
        if (!this[PropertySymbol.baseVal]) {
            this[PropertySymbol.baseVal] = new SVGLengthList_js_1.default(PropertySymbol.illegalConstructor, this[PropertySymbol.window], {
                getAttribute: this[PropertySymbol.getAttribute],
                setAttribute: this[PropertySymbol.setAttribute]
            });
        }
...
exports.default = SVGAnimatedLengthList;
//# sourceMappingURL=SVGAnimatedLengthList.cjs.map
