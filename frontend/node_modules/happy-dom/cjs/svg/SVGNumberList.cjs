...
class SVGNumberList {
    ...
    constructor(illegalConstructorSymbol, window, options) {
        ...
        const methodBinder = new ClassMethodBinder_js_1.default(this, [SVGNumberList]);
    ...
    insertItemBefore(newItem, index) {
        ...
        if (!(newItem instanceof SVGNumber_js_1.default)) {
    ...
    removeItem(index) {
        ...
        if (index >= items.length) {
            throw new this[PropertySymbol.window].DOMException(`Failed to execute 'removeItem' on 'SVGNumberList':  The index provided (${index}) is greater than the maximum bound.`, DOMExceptionNameEnum_js_1.default.indexSizeError);
        }
        if (index < 0) {
            throw new this[PropertySymbol.window].DOMException(`Failed to execute 'removeItem' on 'SVGNumberList':  The index provided (${index}) is negative.`, DOMExceptionNameEnum_js_1.default.indexSizeError);
        }
    ...
    [PropertySymbol.getItemList]() {
        ...
        if (trimmed) {
            ...
            for (let i = 0, max = parts.length; i < max; i++) {
                const item = new SVGNumber_js_1.default(PropertySymbol.illegalConstructor, this[PropertySymbol.window], {
...
//# sourceMappingURL=SVGNumberList.cjs.map
