...
class SVGPointList {
    ...
    constructor(illegalConstructorSymbol, window, options) {
        ...
        const methodBinder = new ClassMethodBinder_js_1.default(this, [SVGPointList]);
    ...
    initialize(newItem) {
        ...
        if (!(newItem instanceof SVGPoint_js_1.default)) {
    ...
    removeItem(index) {
        ...
        if (index >= items.length) {
            throw new this[PropertySymbol.window].DOMException(`Failed to execute 'removeItem' on 'SVGPointList':  The index provided (${index}) is greater than the maximum bound.`, DOMExceptionNameEnum_js_1.default.indexSizeError);
        }
        if (index < 0) {
            throw new this[PropertySymbol.window].DOMException(`Failed to execute 'removeItem' on 'SVGPointList':  The index provided (${index}) is negative.`, DOMExceptionNameEnum_js_1.default.indexSizeError);
        }
    ...
    [PropertySymbol.getItemList]() {
        ...
        if (trimmed) {
            ...
            for (let i = 0, max = parts.length; i < max; i += 2) {
                ...
                const item = new SVGPoint_js_1.default(PropertySymbol.illegalConstructor, this[PropertySymbol.window], {
...
exports.default = SVGPointList;
//# sourceMappingURL=SVGPointList.cjs.map
