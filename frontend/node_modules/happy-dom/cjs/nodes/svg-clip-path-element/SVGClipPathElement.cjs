 ...
 */
class SVGClipPathElement extends SVGElement_js_1.default {
    // Internal properties
    ...
    get clipPathUnits() {
        if (!this[PropertySymbol.clipPathUnits]) {
            this[PropertySymbol.clipPathUnits] = new SVGAnimatedEnumeration_js_1.default(PropertySymbol.illegalConstructor, this[PropertySymbol.window], {
...
exports.default = SVGClipPathElement;
//# sourceMappingURL=SVGClipPathElement.cjs.map
