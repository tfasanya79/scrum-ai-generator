 ...
 */
class SVGFEComponentTransferElement extends SVGElement_js_1.default {
    // Internal properties
...
exports.default = SVGFEComponentTransferElement;
//# sourceMappingURL=SVGFEComponentTransferElement.cjs.map
