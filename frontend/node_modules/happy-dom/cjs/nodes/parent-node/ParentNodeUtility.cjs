...
class ParentNodeUtility {
    ...
    static getElementsByClassName(parentNode, className) {
        return new HTMLCollection_js_1.default(PropertySymbol.illegalConstructor, () => QuerySelector_js_1.default.querySelectorAll(parentNode, `.${className.replace(/\s+/gm, '.')}`)[PropertySymbol.items]);
    }
    /**
    ...
    static getElementsByTagNameNS(parentNode, namespaceURI, tagName) {
        ...
        const formattedTagName = namespaceURI === NamespaceURI_js_1.default.html &&
