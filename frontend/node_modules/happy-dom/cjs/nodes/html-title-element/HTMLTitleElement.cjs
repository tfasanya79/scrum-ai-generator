 ...
 */
class HTMLTitleElement extends HTMLElement_js_1.default {
    /**
     * Returns text.
     *
     * @returns Text.
    ...
    get text() {
        ...
        for (const child of this[PropertySymbol.nodeArray]) {
            if (child[PropertySymbol.nodeType] === NodeTypeEnum_js_1.default.textNode) {
...
//# sourceMappingURL=HTMLTitleElement.cjs.map
