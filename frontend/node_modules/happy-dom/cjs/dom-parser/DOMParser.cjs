    ...
    parseFromString(string, mimeType) {
        ...
        switch (mimeType) {
            case 'text/html':
                ...
                return new HTMLParser_js_1.default(this[PropertySymbol.window]).parse(string, newDocument);
            case 'image/svg+xml':
            case 'text/xml':
            case 'application/xml':
            case 'application/xhtml+xml':
                return new XMLParser_js_1.default(this[PropertySymbol.window]).parse(string);
            default:
